	...
	<div >
		...
		<div class="jumbotron">
			...
			<div class="container" style="height: fit-content; margin-top: 60px;">
				<h2 style="margin-bottom: 25px;">A. Data Peramalan Pendapatan Periode Berikutnya</h2>
		...
		//untuk menentukan nilai peramalan pertama
			...
			//jika data sudah ditampilkan semua, lakukan peramalan untuk bulan berikutnya
				...
				//rumus rata2 abs_err2 MSD
						...
						<h2 style="margin-bottom: 25px; margin-top: 50px;">B. Grafik Peramalan Pendapatan Periode Berikutnya</h2>
						<!-- Grafik -->
						<div class="t">
