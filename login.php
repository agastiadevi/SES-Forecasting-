...
<body class="my-login-page" style="background-color:#198754;">

	<section class="h-100">
		<div class="container h-100">
			<div class="row justify-content-md-center h-100">
				<div class="card-wrapper" style="margin-top: 160px;">
					<div class="card fat" style="border-radius: 20px; width:400px; margin-left:70px;">
						<div class="card-body">
							<?php
							if ($pesan_login !== "") {
